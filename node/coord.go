...
type coordMsg struct {
	...
	Parties   []lss.PartyID `cbor:"4,keyasint,omitempty"`
	...
	Signers     []lss.PartyID `cbor:"7,keyasint,omitempty"`
...
func (n *Node) broadcastCoord(ctx context.Context, targets []lss.PartyID, msg coordMsg) error {
	self := n.host.Self()
